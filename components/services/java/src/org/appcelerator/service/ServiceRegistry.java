...
public class ServiceRegistry
{
    ...
    public static synchronized final void intialize(ServletContext servletContext)
    {
    ...
    //    ServiceRegistry.locators.clear(); why?
     ...
     * @param adapter
     */
    public synchronized static void unregisterService (ServiceAdapter adapter)
    {
    ...
    public synchronized static void registerDownloadableMethods (Class<? extends Object> serviceClass, Object instance, boolean unregisterIfFound) throws Exception
    {
     ...
     */
    public synchronized static void registerDownloadable (Class<? extends Object> clazz, Object instance, 
     ...
     * @throws Exception
     */
    public synchronized static boolean registerService(ServiceAdapter adapter, boolean unregisterIfFound) throws Exception {
        ...
        Set<ServiceAdapter> removes = new HashSet<ServiceAdapter>(); //avoid concurrent modification exception
        ...
        for(ServiceAdapter duplicate : removes) {
            adapters.remove(duplicate);
        }
        removes = null;
    ...
    /**
     * loop through the list of locators and ask them to rescan for services
     *
     */
